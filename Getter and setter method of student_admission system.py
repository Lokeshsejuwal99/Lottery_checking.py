# -------------------------------------------------------------
#  Getter and Setter method of Student Information
# -------------------------------------------------------------
...
class Student:
    ...
    def display_student_information(self):
        ...
        print("Admission Amount:", self.admission_amount, " Thousand only. ")
        print("Discount Amount:", self.discount_amount, " Thousand only.")
        print('Mr',self.name_surname, 'you have to pay rs: ',self.admission_amount, 'thousand.')
